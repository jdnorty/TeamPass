...
$(function() {
    ...
    $("#delete_user").dialog({
		...
		del_user_id = $("#delete_user_id").val();
		del_user = $("#user_login_"+del_user_id).text();
		$.post(
                    "sources/users.queries.php",
                    {
                        type    : "delete_user",
...
function action_on_user(id, action)
{
    ...
    $("#delete_user_login").val($("#user_login_"+id).text());
    $("#delete_user_id").val(id);
    $("#delete_user_show_login").html($("#user_login_"+id).text());
